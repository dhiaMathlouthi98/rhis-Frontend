...
var _Interactable = _interopRequireDefault(require("@interactjs/core/Interactable"));
...
},{"../drag":1,"./DropEvent":2,"@interactjs/core/Interactable":16,"@interactjs/core/scope":24,"@interactjs/utils":55}],4:[function(require,module,exports){
"use strict";
...
Object.defineProperty(exports, "DragEvent", {
  enumerable: true,
  get: function get() {
    return _drag.DragEvent;
  }
});
...
Object.defineProperty(exports, "GestureEvent", {
  enumerable: true,
  get: function get() {
    return _gesture.GestureEvent;
  }
});
...
Object.defineProperty(exports, "ResizeEvent", {
  enumerable: true,
  get: function get() {
    return _resize.ResizeEvent;
  }
});
exports.id = void 0;
...
var _Interaction = require("@interactjs/core/Interaction");
  ...
  checker: function checker(_pointer, _event, interactable, element, interaction, rect) {
    ...
    if (options.resize.enabled) {
      ...
      var resizeEdges = {
        ...
        right: false,
        top: false,
        bottom: false // if using resize.edges

      };

      if (utils.is.object(resizeOptions.edges)) {
        for (var _edge in resizeEdges) {
          resizeEdges[_edge] = checkResizeEdge(_edge, resizeOptions.edges[_edge], page, interaction._latestPointer.eventTarget, element, rect, resizeOptions.margin || this.defaultMargin);
        }
...
function move(_ref2) {
  ...
  for (var _edge2 in inverted) {
    deltaRect[_edge2] = inverted[_edge2] - previous[_edge2];
  }
...
},{"@interactjs/core/Interaction":18,"@interactjs/core/scope":24,"@interactjs/utils":55}],7:[function(require,module,exports){
"use strict";
...
function (_BaseEvent) {
  ...
  function InteractEvent(interaction, event, actionName, phase, element, related, preEnd, type) {
    ...
    _defineProperty(_assertThisInitialized(_this), "currentTarget", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "dragEnter", void 0);

    _defineProperty(_assertThisInitialized(_this), "dragLeave", void 0);
...
function () {
  ...
  function InteractableSet(scope) {
    ...
    _defineProperty(this, "signals", new _Signals["default"]());
  ...
  _createClass(InteractableSet, [{
    ...
    value: function forEachMatch(node, callback) {
      for (var _i = 0; _i < this.list.length; _i++) {
        ...
        if ((is.string(_interactable.target) // target is a selector and the element matches
        ? is.element(node) && domUtils.matchesSelector(node, _interactable.target) : // target is the element
...
function () {
  ...
  function Interaction(_ref) {
    ...
    _defineProperty(this, "_signals", void 0);
    ...
    _defineProperty(this, "_latestPointer", {
      pointer: null,
      event: null,
      eventTarget: null // previous action event
...
},{"./Interaction":18,"./interactionFinder":22,"./scope":24,"@interactjs/utils/Signals":45,"@interactjs/utils/browser":47,"@interactjs/utils/domObjects":49,"@interactjs/utils/events":51,"@interactjs/utils/pointerUtils":60}],24:[function(require,module,exports){
"use strict";
...
function () {
  ...
  function Scope() {
    ...
    _defineProperty(this, "signals", new Signals());
    ...
    _defineProperty(this, "_pluginMap", {});
  ...
  interactions.signals.on('action-start', function (_ref2) {
    ...
    for (var _i = 0; _i < checks.length; _i++) {
      ...
      if (!(options && options.devTools && options.devTools.ignore[check.name]) && check.perform(interaction)) {
        ...
        (_logger = logger).warn.apply(_logger, [prefix + check.text].concat(_toConsumableArray(check.getInfo(interaction))));
      }
    }
  });
...
},{"@interactjs/utils/domObjects":49,"@interactjs/utils/domUtils":50,"@interactjs/utils/extend":52,"@interactjs/utils/is":56,"@interactjs/utils/window":65}],26:[function(require,module,exports){
"use strict";
...
_interact["default"].version = init.version = "1.4.1";
...
function prepareStates(modifierList) {
  ...
  for (var _index = 0; _index < modifierList.length; _index++) {
    var _modifierList$_index = modifierList[_index],
        options = _modifierList$_index.options,
        methods = _modifierList$_index.methods,
        name = _modifierList$_index.name;
...
},{"@interactjs/core/scope":24,"@interactjs/utils/extend":52}],31:[function(require,module,exports){
"use strict";
...
function (_BaseEvent) {
  ...
  function PointerEvent(type, pointer, event, eventTarget, interaction, timeStamp) {
    ...
    _defineProperty(_assertThisInitialized(_this), "double", void 0);

    _defineProperty(_assertThisInitialized(_this), "pageX", void 0);

    _defineProperty(_assertThisInitialized(_this), "pageY", void 0);

    _defineProperty(_assertThisInitialized(_this), "clientX", void 0);

    _defineProperty(_assertThisInitialized(_this), "clientY", void 0);

    _defineProperty(_assertThisInitialized(_this), "dt", void 0);

    _defineProperty(_assertThisInitialized(_this), "eventable", void 0);
...
var _Interaction = _interopRequireDefault(require("@interactjs/core/Interaction"));
...
},{"./PointerEvent":38,"@interactjs/core/Interaction":18,"@interactjs/core/scope":24,"@interactjs/utils":55}],40:[function(require,module,exports){
"use strict";
...
},{"@interactjs/utils/arr":46,"@interactjs/utils/extend":52}],43:[function(require,module,exports){
"use strict";
...
},{"@interactjs/core/InteractEvent":15,"@interactjs/core/Interactable":16,"@interactjs/core/Interaction":18,"@interactjs/utils":55}],44:[function(require,module,exports){
...
function addDelegate(selector, context, type, listener, optionalArg) {
  ...
  if (!delegatedEvents[type]) {
    delegatedEvents[type] = {
      contexts: [],
      listeners: [],
      selectors: [] // add delegate listener functions
...
var pointerUtils = {
  ...
  getPageXY: function getPageXY(pointer, page) {
    page = page || {
      x: 0,
      y: 0 // Opera Mobile handles the viewport and scrolling oddly
